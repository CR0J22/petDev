...
import { ChevronRight, ChevronLeft, Hotel, Scissors, Syringe, CarTaxiFront, Clock } from "lucide-react"
                    ...
                    <div className="overflow-hidden " ref={emblaRef}>
                        ...
                        <div className="flex">
                            {services.map((item, index) => (
                                <div key={index} data-aos="zoom-out" className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3 ">
                                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                        ...
                                        <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                                            ...
                                            <a
                                                ...
                                                className="flex items-center gap-2 justify-center px-4 py-1 rounded-lg hover:bg-green-600 duration-300"
                                            >
